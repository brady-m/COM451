...
MyViz: interface.o PDP1_turdubaev_arstan.o PDP2_turdubaev_arstan.o animate.o gpu_main.o
	g++ -o MyViz interface.o PDP1_turdubaev_arstan.o PDP2_turdubaev_arstan.o gpu_main.o animate.o $(F1) $(F2) $(F3) $(F4) $(F5) $(F6)

# do we really need all these flags to compile interface??!!
interface.o: interface.cpp PDP2_turdubaev_arstan.cpp gpu_main.cu animate.cu
	g++ -w -c interface.cpp $(F1) $(F2)
	
PDP2_turdubaev_arstan.o: PDP2_turdubaev_arstan.cpp gpu_main.cu animate.cu
	g++ -w -c PDP2_turdubaev_arstan.cpp $(F1) $(F2)

PDP1_turdubaev_arstan.o: PDP1_turdubaev_arstan.cpp
	g++ -w -c PDP1_turdubaev_arstan.cpp
